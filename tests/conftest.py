"""Shared test fixtures for the Coloring Page Factory."""
...
def mock_deepseek_response():
    ...
    return {
        "refined_prompt": "Black and white line art coloring page of a friendly cartoon dragon standing in a meadow with flowers. Thick clear outlines, white background, no shading, child-friendly simplicity.",
